 ...
 */
Ext.define("App.Sys.KeleCloud.Widget.ServerMgr", {
   extend: "WebOs.Kernel.ProcessModel.AbstractWidget",
   requires: [
      "App.Sys.KeleCloud.Comp.ServerInfoEditorWin"
   ],
   ...
   getInfoEditor: function()
   {
      if(null==this.infoEditorRef){
         this.infoEditorRef = new App.Sys.KeleCloud.Comp.ServerInfoEditorWin({
            listeners: {
   ...
   getServerMetaInfoConfig: function()
   {
      ...
      return {
         ...
         columns: [
            ...
            {text: COLS.INSTANCE_COUNT, dataIndex: "instanceCount", width: 200, resizable: false, menuDisabled: true}
         ],
         autoScroll: true,
         store: new Ext.data.Store({
            ...
            fields: [
               ...
               {name: "instanceCount", type: "string"}
            ],
            proxy: {
               type: "apigateway",
               callType: "App",
