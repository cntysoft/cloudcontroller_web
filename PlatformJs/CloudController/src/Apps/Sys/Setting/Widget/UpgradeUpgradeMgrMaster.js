 ...
 */
Ext.define("App.Sys.Setting.Widget.UpgradeUpgradeMgrMaster", {
   extend: "WebOs.Kernel.ProcessModel.AbstractWidget",
   initPmTextRef: function()
   {
      this.pmText = this.GET_PM_TEXT("UPGRADE_UPGRADEMGR_MASTER");
   },
   initLangTextRef: function()
   {
      this.LANG_TEXT = this.GET_LANG_TEXT("UPGRADE_UPGRADEMGR_MASTER");
   },
   statics: {
      KEY_SEED_ID: 1
   },
