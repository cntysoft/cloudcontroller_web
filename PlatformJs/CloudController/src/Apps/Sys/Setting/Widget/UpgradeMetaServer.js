 ...
 */
Ext.define("App.Sys.Setting.Widget.UpgradeMetaServer", {
   extend: "WebOs.Kernel.ProcessModel.AbstractWidget",
   initPmTextRef: function()
   {
      this.pmText = this.GET_PM_TEXT("UPGRADE_META_SERVER");
   },
   initLangTextRef: function()
   {
      this.LANG_TEXT = this.GET_LANG_TEXT("UPGRADE_META_SERVER");
   },
   statics: {
      KEY_SEED_ID: 1
   },
