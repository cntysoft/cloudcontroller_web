 ...
 */
Ext.define("App.Sys.Setting.Widget.LuoXiVersion", {
   ...
   {
      this.pmText = this.GET_PM_TEXT("LUOXI_VERSION_INFO");
   },
   initLangTextRef: function()
   {
      this.LANG_TEXT = this.GET_LANG_TEXT("LUOXI_VERSION_INFO");
   },
   metaInfoGrid: null,
   infoEditorRef: null,
   contextMenuRef: null,
   ...
   getVersionHandler : function(item)
   {
      ...
      this.appRef.getLuoXiVersion(item.parentMenu.record.get("ip"), function(response){
         this.loadMask.hide();
         var version;
