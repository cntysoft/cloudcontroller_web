 ...
 */
Ext.define('App.Sys.Searcher.Comp.GInfosCategoryTree', {
   extend : 'Ext.tree.Panel',
   alias : 'widget.syssearchercompginfoscategorytree',
   requires : [
   ...
   invokeMetaInfo : {
      module : 'Sys',
      name : 'Searcher',
      method : 'IndexBuilder/getGInfoCategoryChildren'
   },
   allowTypes : [3],
   extraFields : [],
   ...
   createTreeStore : function()
   {
      return new SenchaExt.Data.TreeStore({
         ...
         root : {
            text : this.GET_LANG_TEXT('COMP.GINFOS_CATEGORY_TREE.ROOT_NODE'),
            id : 0,
            expanded : true
         },
         fields : [
