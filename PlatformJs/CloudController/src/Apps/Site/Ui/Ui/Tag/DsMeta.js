 ...
 */
Ext.define('App.Site.Ui.Ui.Tag.DsMeta',{
   extend : 'Ext.form.Panel',
   alias : 'widget.siteuiuitagdsmeta',
   requires : [
   ...
   {
      config = config || {};
      this.LANG_TEXT = this.GET_LANG_TEXT('TAG.TAG_EDITOR.DS_META');
   ...
   getFormConfig : function()
   {
      ...
      return [{
         ...
         tagType : App.Site.Ui.Lib.Const.TAG_DS,
         allowBlank : false,
         name : 'category',
         listeners : {
