 ...
 */
Ext.define('App.ZhuChao.UserCenter.Ui.Foreman.Info', {
    extend : 'Ext.tab.Panel',
    requires : [
        'App.ZhuChao.UserCenter.Ui.Foreman.BasicSetting',
        'App.ZhuChao.UserCenter.Ui.Foreman.DetailInfo'
    ],
    mixins : {
    ...
    {
        config = config || {};
        this.LANG_TEXT = this.GET_LANG_TEXT('UI.FOREMAN.INFO');
...
//         this.setValues(defaultValues);
    ...
    {
        this.basicSettingRef = Ext.create('App.ZhuChao.UserCenter.Ui.Foreman.BasicSetting', {
            mainPanelRef : this.mainPanelRef,
            infoRef : this
        });
        this.detailInfoRef = Ext.create('App.ZhuChao.UserCenter.Ui.Foreman.DetailInfo', {
            mainPanelRef : this.mainPanelRef,
            infoRef : this
        });
