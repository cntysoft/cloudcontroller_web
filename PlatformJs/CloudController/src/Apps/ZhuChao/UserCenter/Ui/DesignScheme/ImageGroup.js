 ...
 * 图片选择器
 */
Ext.define('App.ZhuChao.UserCenter.Ui.DesignScheme.ImageGroup', {
   ...
   {
      config = config || {};
      this.LANG_TEXT = this.GET_LANG_TEXT('UI.DESIGN_SCHEME.IMAGE_GROUP');
   ...
   getImageViewConfig : function()
   {
      return {
         ...
         autoScroll : true,
         items : {
            xtype : 'zhuchaousercenteruidesignschemeiconview',
            iconHeight : 160,
            iconWidth : 120,
