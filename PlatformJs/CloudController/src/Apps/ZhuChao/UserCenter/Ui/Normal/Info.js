 ...
 */
Ext.define('App.ZhuChao.UserCenter.Ui.Normal.Info', {
    extend : 'Ext.tab.Panel',
    requires : [
        'App.ZhuChao.UserCenter.Ui.Normal.BasicSetting',
        'App.ZhuChao.UserCenter.Ui.Normal.DetailInfo'
    ],
    mixins : {
    ...
    {
        config = config || {};
        this.LANG_TEXT = this.GET_LANG_TEXT('UI.NORMAL.INFO');
...
//         this.setValues(defaultValues);
    ...
    {
        this.basicSettingRef = Ext.create('App.ZhuChao.UserCenter.Ui.Normal.BasicSetting', {
            mainPanelRef : this.mainPanelRef,
            infoRef : this
        });
        this.detailInfoRef = Ext.create('App.ZhuChao.UserCenter.Ui.Normal.DetailInfo', {
            mainPanelRef : this.mainPanelRef,
            infoRef : this
        });
