 ...
 */
Ext.define('App.ZhuChao.UserCenter.Ui.Decorator.Info',{
   extend: 'Ext.tab.Panel',
   requires : [
      'App.ZhuChao.UserCenter.Ui.Decorator.BaseInfo',
      'App.ZhuChao.UserCenter.Ui.Decorator.BasicSetting',
      'App.ZhuChao.UserCenter.Ui.Decorator.ServiceSetting',
      'App.ZhuChao.UserCenter.Ui.Decorator.CertificateSetting',
      'App.ZhuChao.UserCenter.Ui.Decorator.MemberSetting'
   ],
   mixins: {
   ...
   {
      config = config || {};
      this.LANG_TEXT = this.GET_LANG_TEXT('UI.DECORATOR.INFO');
      this.fileRefs = [];
...
//         this.setValues(defaultValues);
   ...
   setValues : function(values)
   {
      var panels = [
         ...
         this.serviceSettingRef, 
         this.certificateSettingRef,
         this.MemberSettingRef
      ];
   ...
   {
      this.baseInfoRef = Ext.create('App.ZhuChao.UserCenter.Ui.Decorator.BaseInfo', {
         mainPanelRef : this.mainPanelRef,
         infoRef : this
      });
      this.basicSettingRef = Ext.create('App.ZhuChao.UserCenter.Ui.Decorator.BasicSetting', {
         mainPanelRef : this.mainPanelRef,
         infoRef : this
      });
      this.serviceSettingRef = Ext.create('App.ZhuChao.UserCenter.Ui.Decorator.ServiceSetting', {
         mainPanelRef : this.mainPanelRef,
         infoRef : this
      });
      this.certificateSettingRef = Ext.create('App.ZhuChao.UserCenter.Ui.Decorator.CertificateSetting', {
         mainPanelRef : this.mainPanelRef,
         infoRef : this
      });
      if(this.mode == CloudController.Const.NEW_MODE){
         return [this.baseInfoRef, this.basicSettingRef, this.serviceSettingRef, this.certificateSettingRef];
      }
      
      this.MemberSettingRef = Ext.create('App.ZhuChao.UserCenter.Ui.Decorator.MemberSetting', {
            mainPanelRef : this.mainPanelRef,
            infoRef : this,
            decoratorId : this.targetLoadId
         });
         return [this.baseInfoRef, this.basicSettingRef, this.serviceSettingRef, this.certificateSettingRef, this.MemberSettingRef];
   },
   ...
   destroy : function()
   {
      delete this.baseInfoRef;
      delete this.basicSettingRef; 
      delete this.serviceSettingRef; 
      delete this.certificateSettingRef;
      delete this.MemberSettingRef;
      delete this.appRef;
