 ...
 */
Ext.define('App.ZhuChao.UserCenter.Ui.Decorator.ListView',{
   ...
   {
      config = config || {};
      this.LANG_TEXT = this.GET_LANG_TEXT('UI.DECORATOR.LIST_VIEW');
   ...
   initComponent : function()
   {
      ...
      Ext.apply(this, {
         ...
         store : store,
         columns : [
            {text : F.LOGO, dataIndex : 'avatar', width : 210, resizable : false, sortable : false, menuDisabled : true, renderer : this.logoRenderer, autoScroll:true},
            {text : F.NICK_NAME, dataIndex : 'nickname', flex : 3 , resizable : false, sortable : false, menuDisabled : true},
            {text : F.ADDRESS, dataIndex : 'address', flex : 2, resizable : false, sortable : false, menuDisabled : true},
            {text : F.SERVICE_AREA, dataIndex : 'serviceArea', flex : 2, resizable : false, sortable : false, menuDisabled : true},
            {text : F.IS_AUTHED, dataIndex : 'isAuthed', width : 100, resizable : false, sortable : false, menuDisabled : true, renderer : this.authRenderer},
            {text : F.STATUS, dataIndex : 'status', width : 100, resizable : false, sortable : false, menuDisabled : true, renderer : this.statusRenderer}
         ],
         tbar : [{
            text : this.LANG_TEXT.BTN.ADD_DECORATOR,
            listeners : {
               click : function(){
   ...
   createDataStore : function()
   {
      return new Ext.data.Store({
         ...
         fields : [
            ...
            {name : 'serviceArea', type : 'string', persist : false},
            {name : 'isAuthed', type : 'integer', persist : false},
