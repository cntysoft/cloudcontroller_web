 ...
 * @param {type} param2
 */
Ext.define('App.ZhuChao.MarketMgr.Ui.SellerSign.ListView', {
   ...
   {
      config = config || {};
      this.LANG_TEXT = this.GET_LANG_TEXT('SELLERSIGN.LISTVIEW');
   ...
   initComponent : function ()
   {
      ...
      Ext.apply(this, {
         ...
         columns : [
            ...
            {text : this.LANG_TEXT.NAME, dataIndex : 'name', resizable : false, menuDisabled : true},
            {text : this.LANG_TEXT.SELLERNAME, dataIndex : 'sellerName', resizable : false, menuDisabled : true, flex : 1},
            {text : this.LANG_TEXT.SIGNTIME, dataIndex : 'signTime', resizable : false, menuDisabled : true, width : 200},
   ...
   contextMenuClickHandler : function (menuItem)
   {
      ...
      this.mainPanelRef.appRef.sellerSignContextMenuClick(res, function (response){
         if(!response.status){
         ...
         this.gridStore = new Ext.data.Store({
            ...
            proxy : {
               ...
               invokeMetaInfo : {
                  module : 'ZhuChao',
                  name : 'MarketMgr',
                  method : 'SellerSign/getSellerSignList'
               },
               reader : {
                  type : 'json',
                  rootProperty : 'items',
