 ...
 * 图片选择器
 */
Ext.define('App.ZhuChao.MarketMgr.Ui.Gift.GiftInfoImageGroup', {
    ...
    {
        config = config || {};
        this.LANG_TEXT = this.GET_LANG_TEXT('UI.ATTRS.Gift_INFO.IMAGE_GROUP');
    ...
    createImageListStore : function ()
    {
        return new Ext.data.Store({
            fields : [
                ...
                {name : 'space', type : 'string', persist : false},
    ...
    setImageConfigHandler : function (menu)
    {
        ...
        textarea = this.imageConfigWinRef.down('combo');
        textarea.setValue(record.data.space);
    ...
    imageConfigWindowBtnClickHandler : function (btn)
    {
        ...
        var item = win.item;
        var textarea = win.down('combo');
        var value = textarea.getValue();
        record.data.space = value;
