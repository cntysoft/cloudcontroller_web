 ...
 */
Ext.define('App.ZhuChao.Goods.Comp.TrademarkCategoryTree', {
   extend : 'Ext.tree.Panel',
   alias : 'widget.zhuchaogoodscompcategorytree',
   requires : [
   ...
   invokeMetaInfo : {
      module : 'ZhuChao',
      name : 'Goods',
      method : 'Mgr/getTrademarkCategories'
   },
   ...
   createTreeStore : function()
   {
      ...
      return new SenchaExt.Data.TreeStore({
         ...
         proxy : {
            ...
            {
               params.trademarkId = me.trademarkId;
