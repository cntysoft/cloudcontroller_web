...
Ext.define('App.ZhuChao.Goods.Comp.GCategoryTree', {
   extend : 'Ext.tree.Panel',
   alias : 'widget.zhuchaocategorymgrcompgcategorytree',
   requires : [
   ...
   invokeMetaInfo : {
      module : 'ZhuChao',
      name : 'Goods',
      method : 'Mgr/getGoodsCategoryChildren'
   },
   ...
   applyConstraintConfig : function(config)
   {
      Ext.apply(config, {
         ...
         frame : false,
         border : false,
         title : this.GET_LANG_TEXT('COMP.G_CATEGORY_TREE.PANEL_TITLE')
      });
   },
